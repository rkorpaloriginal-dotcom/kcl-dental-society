...
export const ANNUAL_TRADITIONS: AnnualTradition[] = [
  {
    ...
    name: 'Freshers\' Week',
    month: 'September',
    description: 'A week of welcome socials and sign-ups that kicks off the academic year.',
  ...
  },
  {
    ...
    month: 'October',
    description: 'Fancy dress, music, and one of the most-loved socials of the calendar.',
  ...
  },
  {
    ...
    name: 'Christmas Ball',
    month: 'December',
    description: 'A black-tie dinner and dance marking the end of the autumn term.',
    image: '/images/events/formals.jpg',
  },
  {
    slug: 'revision-weekend',
    name: 'Revision Weekend',
    month: 'April',
    description: 'Structured group study sessions and wellbeing breaks ahead of exams.',
  ...
  },
  {
    ...
    name: 'Summer Ball',
    month: 'June',
    description: 'The final flagship formal of the year, celebrating the graduating class.',
