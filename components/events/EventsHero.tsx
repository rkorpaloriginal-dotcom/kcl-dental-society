    ...
    <section className="bg-navy">
      <div className="mx-auto grid max-w-7xl gap-10 px-6 py-20 md:grid-cols-12 md:items-center md:py-28">
        <div className="md:col-span-5">
          ...
          <StaggeredHeadline
            text="A full programme, all year round."
          ...
          <p className="mt-6 max-w-sm text-base leading-relaxed text-cream/70">
            From formal dinners and flagship socials to hands-on clinics, careers events,
            and inter-uni competitions - this is how the dental school shows up for each other.
          </p>
